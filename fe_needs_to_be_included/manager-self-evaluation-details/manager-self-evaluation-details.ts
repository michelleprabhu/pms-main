...
@Component({
  selector: 'app-manager-self-evaluation-details',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './manager-self-evaluation-details.html',
  styleUrls: ['./manager-self-evaluation-details.css']
})
export class ManagerSelfEvaluationDetailsComponent implements OnInit {
