...
class ScoreCardCompetency(db.Model):
    __tablename__ = 'score_card_competencies'
    ...
    library_id = db.Column(db.Integer, db.ForeignKey('competencies_library.id'), nullable=True)
    ...
    # Relationships
    score_card = db.relationship('ScoreCard', backref='competencies')
    library_item = db.relationship('CompetenciesLibrary')
